...
namespace api_dev_lessons.Controllers
{
    ...
    public class CountriesController : ControllerBase
    {
        ...
        {
            var countries = await _countriesRepository.GetAllAsync(null);
        ...
        {
            var country = this.mapper.Map<Country>(createdCountry);

            await _countriesRepository.AddAsync(entity: country);
